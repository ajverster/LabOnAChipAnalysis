...
python lib/combine_for_db.py -i GCA_002213925.1_ASM221392v1_genomic.fna -n Lmonocytogenes_4b -i GCF_000732965.1_ASM73296v1_genomic.fna -n EcoliO157EDL933 -i GCF_016864495.1_ASM1686449v1_genomic.fna -n Senterica_ATCC14028 -o combined_strain.fasta --mode first
